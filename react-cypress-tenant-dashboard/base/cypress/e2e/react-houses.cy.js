...
data.forEach(({ submission_link: url, id, json_server_link: server_url }) => {
  describe("React Assignment", function () {
    ...
    it("Check Sorting by Rent - ascending order", () => {
      cy.intercept("GET", `**/houses?q=&_sort=rent&_order=asc`).as("sortHousesAsc");
      cy.visit(url);
    ...
    it("Check Sorting by Rent - descending order", () => {
      cy.intercept("GET", `**/houses?q=&_sort=rent&_order=desc`).as("sortHousesDesc");
      cy.visit(url);
      cy.get(".houseDetails").its("length").should("equal", mock.houses.length);
    ...
    it("Check if Add Details is updating table data", () => {
